...
const CompassIcon = () => (
  <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="lux-compass-svg">
    {/* Outer Circle */}
...
export default function Navbar() 
{
  ...
  return (
    <nav className="lux-navbar" id="lux-transparent-nav">
      <div className="lux-nav-container">
        ...
        <div className="lux-nav-right">
          ...
          <div className="lux-nav-sep"></div>
          
          <Link to="/plan" className="lux-cta-pill">
